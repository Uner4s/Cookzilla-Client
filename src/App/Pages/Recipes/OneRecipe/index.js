    ...
    return oneRecipe.ingredient.map(ingredient => {
      return (
        <div key={ingredient._id} className="row">
          <div className="col-xs-12 col-sm-12">{ingredient.name}</div>
        </div>
      )
    })
  }
    ...
    return oneRecipe.tool.map(tool => {
      return (
        <div key={tool._id} className="row">
          <div className="col-xs-12 col-sm-12">{tool.name}</div>
        </div>
      )
    })
  }
        ...
        <div className="col-xs-12 col-u sm-12">
          ...
          <div className="row">
            <h4 className="col-xs-6">
              Tools: <h5>{this.renderTools()}</h5>
            </h4>
            <h4 className="col-xs-6">
              Ingredients: <h5>{this.renderIngredients()}</h5>
            </h4>
          </div>
